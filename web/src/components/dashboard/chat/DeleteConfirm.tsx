          ...
          >
            <div className="th-bg-bg inline-block align-bottom rounded-xl border th-border-for text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="th-bg-bg px-4 pt-5 pb-4 sm:p-6 sm:pb-4 flex items-center">
                <div>
                  <h5 className="font-bold th-color-for">
                    {t("Are_you_want_to_delete_this_message")}
                  </h5>
                </div>
              </div>
              <div className="px-4 pb-4 pt-2 border-t th-border-for sm:px-6 sm:flex sm:flex-row-reverse sm:justify-start">
                ...
                <button onClick={deleteMessage} className="th-bg-bg th-color-brred th-border-brred border-2 text-sm w-20 h-10 rounded font-bold focus:z-10 focus:outline-none">
                  {t("Delete")}
                </button>
