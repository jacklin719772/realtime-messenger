        ...
        <div className="w-full flex flex-col justify-center space-y-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col">
              <div className="font-bold text-base th-color-for">{isVideoDisabled ? `${value?.name} ${t("Voice_Call")}` : `${value?.name} ${t("Video_Call")}`}</div>
              <div className="w-full text-xs th-color-for">{t("Waiting_for_invitees_to_accept_the_invitation")}</div>
            </div>
          </div>
          )}
          {dmId && (
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="w-full text-xs th-color-for">{t("Waiting_for_invitee_to_accept_the_invitation")}</div>
            </div>
          </div>
          )}
