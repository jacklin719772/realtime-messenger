  ...
  return (
    <div id="toolbar" className="flex items-center justify-between w-full">
      ...
      <div className="ml-auto flex items-center space-x-2">
        <svg className="mx-1 h-auto w-5 cursor-pointer th-color-for" onClick={handleOnVideoClick} xmlns="http://www.w3.org/2000/svg" version="1.0" width="512" height="452" stroke-width="50" viewBox="0 0 512.000000 452.000000" preserveAspectRatio="xMidYMid meet">
